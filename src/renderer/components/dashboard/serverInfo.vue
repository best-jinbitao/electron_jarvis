    ...
    this.$store
      .dispatch("SSH2ExecTop", {
        ...
        callback: (ssh, top) => {
          ...
          //CPU
          this.timeData.push(
            this.$options.filters.parseTime(new Date(), "{h}:{i}:{s}")
          );
          this.cpuVal = top
            .trim()
            .split("\n")[2]
            ...
            .replace(/[^0-9|\.]/g, "");
          this.cpuVal > 90
            ? (this.cpuColor = "#B3C0D1")
            : (this.cpuColor = "transparent");
          ...
          this.ramArr = top
            ...
            .split(",");
          this.ramVal =
            ((this.ramArr[1] / this.ramArr[0]) * 100).toFixed(2) - 0;
          this.ramVal > 90
            ? (this.ramColor = "#B3C0D1")
            : (this.ramColor = "transparent");
